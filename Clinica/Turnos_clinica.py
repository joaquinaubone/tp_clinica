...
from Clinica.Excepciones_clinica import EspecialidadYaExistente, ErrorPaciente, ErrorMedico, RecetaInvalidaException, PacienteNoEncontradoExcepcion, MedicoNoDisponibleExcepcion, TurnoOcupadoException, ErrorGeneralTurno
