...
from Clinica.Turnos_clinica import (Paciente, Medico, Clinica, Especialidad)
from Clinica.Excepciones_clinica import (ErrorAlAgregarMedico, ErrorAlAgregarPaciente, ErrorGeneralTurno, PacienteNoEncontradoExcepcion, MedicoNoDisponibleExcepcion, TurnoOcupadoException, ErrorPaciente, ErrorMedico, RecetaInvalidaException, EspecialidadYaExistente)
